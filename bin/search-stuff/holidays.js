...
function getData (){
     ...
     },
     {
          ...
          "type":"holiday",
          // "description":"Summer",
         // "searchValue":"holiday^holiday-summer",
         // "localesAvailableIn":["en-US"]
     },
     {
          // "id":"holiday-fall",
          ...
          "type":"holiday",
          // "description":"Fall",
         // "searchValue":"holiday^holiday-fall",
         // "localesAvailableIn":["en-US"]
     },
     {
          // "id":"holiday-new-year",
     ...
     },
     {
         ...
         // "searchValue":"holiday^holiday-super-bowl",
         // "localesAvailableIn":["en-US"]
     },
     {
          // "id":"holiday-winter",
          ...
          "type":"holiday",
          // "description":"Winter",
         // "searchValue":"holiday^holiday-winter",
         // "localesAvailableIn":["en-US"]
     },
     {
          // "id":"holiday-spring",
          ...
          "type":"holiday",
          // "description":"Spring",
         // "searchValue":"holiday^holiday-spring",
         // "localesAvailableIn":["en-US"]
     },
     {
     ...
     },
     {
         ...
         // "searchValue":"holiday^holiday-valentines-day",
         // "localesAvailableIn":["en-US"]
     },
     {
          // "id":"holiday-hanukkah",
     ...
     },
     {
         ...
         // "searchValue":"holiday^holiday-passover",
         // "localesAvailableIn":["en-US"]
     },
     {
          // "id":"holiday-easter",
          ...
          "type":"holiday",
          // "description":"Easter",
         // "searchValue":"holiday^holiday-easter",
         // "localesAvailableIn":["en-US"]
     },
     {
         ...
         // "searchValue":"holiday^holiday-st-patricks-day",
         // "localesAvailableIn":["en-US"]
     },
     {
         ...
         // "searchValue":"holiday^holiday-chinese-new-year",
         // "localesAvailableIn":["en-US"]
     },
     {
         ...
         // "searchValue":"holiday^holiday-4th-of-july",
         // "localesAvailableIn":["en-US"]
     }
     ];
